...
kezhiDesc["正"]={
	...
	["华山剑法"]={"「白云出岫","「天绅倒悬","「青山隐隐","「古柏森森","「苍松迎客","「无双无对","「落花无意","「有凤来仪」，剑势飞舞而出，轻盈灵动","突然剑锋一转，使出「白虹贯日」直刺","斜晃反挑，一式「无边落木」，这一下出招急快，抑且如梦如幻",},
...
kezhiDesc["刚"]={
	...
	["降龙十八掌"]={"「亢龙有悔","「飞龙在天","「鸿渐于陆","「潜龙勿用","「突如其来","「或跃在渊","「双龙取水","「鱼跃于渊","「时乘六龙","「密云不雨","「损则有孚","「龙战于野","「履霜冰至","「羝羊触蕃","神龙摆尾」拍向身后的","「神龙摆尾」出其不意","「见龙在田」，迅捷无比地劈向","中宫空门大开，双掌一上一下","这是一招「震惊百里」"},
	...
	["神龙腿法"]={"「星罗棋布","「倒踩七星","「神龙摆尾」，右脚前跨","「蛇行无踪","「旋风无敌","「无影神腿","「神龙八腿","「流星赶月」，连腿影都看不清",},
...
kezhiDesc["快"]={
	...
	["四象掌"]={"「五气呈祥","「逆流捧沙","「雷洞霹雳","「梵心降魔","遥遥一鞠，一式「三阳开泰」，双掌大开大阖",},
...
kezhiDesc["慢"]={
	...
	["黯然销魂掌"]={"「徘徊空谷","「力不从心","「行尸走肉","「庸人自扰","「倒行逆施","「废寝忘食","「孤形只影","「饮恨吞声","「穷途末路","「面无人色","「想入非非","翻身坐倒，旋及旋向空中，凭空一式","身畔，一式「呆若木鸡」，乘",},
