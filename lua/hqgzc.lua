...
function hqgzcCaiPuDetail1(n, l, w)
    ...
    for
        key, value in pairs(cooking.target)
    do
...
function hqgzcCaiPuDetail2()
    ...
    do
        ...
        for
            key1, value in pairs(cooking.jiangnan)
        do
        ...
        for
            key2, value in pairs(cooking.zhongyuan)
        do
            if string.find(cooking.where[key], value) then
                cooking.flag[key] = 2
            end
        ...
        for
            key3, value in pairs(cooking.hebei)
        do
            if string.find(cooking.where[key], value) then
                cooking.flag[key] = 3
            end
...
function hqgzcWhereConsider()
    for
        key, value in pairs(cooking.where)
    do
