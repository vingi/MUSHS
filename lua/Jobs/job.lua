...
job.list={}
sxjob={}
sxjob.ide='令狐冲|黄令天|凌震天|中年乞丐|青年乞丐|灰衣帮众|五毒教弟子|慧真尊者|知客道长|巨木旗教众|锐金旗教众|洪水旗教众|厚土旗教众|烈火旗教众|出尘子|李捕头|值勤兵|樊一翁|张巡捕|护法使者|夏雪宜|蒙面人|黑衣帮众|土匪|马贼|大衙役'
sxjob.cancel=''
sxjob.skillslist=''
sxjob.killer1='杀手一'
sxjob.killer1='杀手二'
sxjob.skills='XXXXX'
sxjob.sx2=0
gaibangCancel='黄蓉|杨逍|钟万仇|任盈盈|薛慕华|凌震天|黄天令|张浩天|洪啸天|丁勉|静风师太|陆大有|高升泰|西华子|张浩天|洪啸天|看守|尼摩星|看窑弟子|赵敏|出尘子|吕文德|侯君集|忽必烈|摘星子|飘然子|黯然子|狮吼子|阿紫|马掌柜|飞天子'
sldsmCancel='黄蓉|杨逍|钟万仇|任盈盈|薛慕华|凌震天|黄天令|张浩天|洪啸天|丁勉|静风师太|陆大有|高升泰|马光佐|张浩天|洪啸天|西华子|执勤兵|玉玑子|玉磬子|玉音子|梁子翁|吕文德|达尔巴|看守|尼摩星|看窑弟子|赵敏|出尘子|侯君集|忽必烈|摘星子|飘然子|黯然子|狮吼子|阿紫|马掌柜|飞天子'
wudangcancel=''
sx2joblevel='微不足道|马马虎虎|小有所成|融会贯通|颇为了得|极其厉害'
jiangnan_area='佛山镇|福州城|杭州城|嘉兴城|梅庄|姑苏慕容|燕子坞|曼佗罗山庄|宁波城|莆田少林|苏州城|牛家村|归云庄'
zhongyuan_area='苗疆|长乐帮|成都城|扬州城|大理城|无量山|大理皇宫|大理王府|终南山|玉虚观|峨嵋山|襄阳郊外|黄河流域|萧府|华山|南阳城|嵩山|嵩山少林|大理城西|大理城南|大理城东|泰山|铁掌山|天龙寺|华山村|武当山|襄阳城|柳宗镇|大雪山|中原|成都郊外|大理城北|长安城'
cjn_area='长江南岸|江南官道'
job.level='XXXXX'
wudangjobok=0
mytime=0
...
--    create_trigger_t('fight4',"^(> )*看起来(\\D*)想杀死你！$",'','fightConsider')
    ...
    create_trigger_t('fight6',"^(> )*你(必须拿着|使用的兵刃不对|使用的兵刃不正确|使用的武器不对|所使用的外功中没有这种功能|不够狠毒|掏了掏背囊，发现里面的暗器已经不够)",'','noweaponpfm')
...
prepare_neili_b=function()
   ...
   if score.party=="普通百姓" and nobusy==0 and condition.busy~=nil and condition.busy>=100 and hp.pot>=60 then
	...
	elseif (skills["force"].lvl>200 and skills["force"].lvl<hp.pot_max-100) or (skills["dodge"].lvl>101 and skills["dodge"].lvl<hp.pot_max-100) or (skills["parry"].lvl>101 and skills["parry"].lvl<hp.pot_max-100) then
...
function job_exp_tongji(p_cmd)
	...
	if flag.log and flag.log=="yes" then
       messageShowT('任务奖励统计：共运行【'.. l_hour ..'小时'.. l_min .. '分' .. l_sec ..'秒' ..'】，获得经验【'..l_exp..'】点，平均每小时【'..l_avg..'】点！','orange')
    else
	   ColourNote ("white","black",'任务奖励统计：共运行【'.. l_hour ..'小时'.. l_min .. '分' .. l_sec ..'秒' ..'】，获得经验【'..l_exp..'】点，平均每小时【'..l_avg..'】点！')    
	end
end
...
function thdTrigger()
    ...
    create_trigger_t('thdAccept1',"^(> )*黄蓉在你的耳边悄声说道：据说(江南|江北|西南|中原|西北|河南|河北|东北)(草寇|寨主|恶霸|山贼|土匪|飞贼|盗贼)(\\D*)正在(\\D*)捣乱",'','thdConsider')
...
zhunbeineili=function(func,p_cmd)
    ...
    if hp.neili>=hp.neili_max*1.5 then
      return check_bei(job.prepare)
        ...
        create_trigger_t('zbneili1',"^(> )*(过了片刻，你感觉自己已经将玄天无极神功|你将寒冰真气按周天之势搬运了一周|你只觉真力运转顺畅，周身气力充沛|你将纯阳神通功运行完毕|你只觉神元归一，全身精力弥漫|你将内息走了个一个周天|你将内息游走全身，但觉全身舒畅|你将真气逼入体内，将全身聚集的蓝色气息|你将紫气在体内运行了一个周天|你运功完毕，站了起来|你一个周天行将下来，精神抖擞的站了起来|你分开双手，黑气慢慢沉下|你将内息走满一个周天，只感到全身通泰|你真气在体内运行了一个周天，冷热真气收于丹田|你真气在体内运行了一个周天，缓缓收气于丹田|你双眼微闭，缓缓将天地精华之气吸入体内|你慢慢收气，归入丹田，睁开眼睛|你将内息又运了一个小周天，缓缓导入丹田|你感觉毒素越转越快，就快要脱离你的控制了！|你将周身内息贯通经脉，缓缓睁开眼睛，站了起来|你呼翕九阳，抱一含元，缓缓睁开双眼|你吸气入丹田，真气运转渐缓，慢慢收功|你将真气在体内沿脉络运行了一圈，缓缓纳入丹田|你将内息在体内运行十二周天，返回丹田|你将内息走了个小周天，流回丹田，收功站了起来|过了片刻，你已与这大自然融合在一起，精神抖擞的站了起|你感到自己和天地融为一体，全身清爽如浴春风，忍不住舒畅的呻吟了一声，缓缓睁开了眼睛)",'','zhunbeineili_b')
