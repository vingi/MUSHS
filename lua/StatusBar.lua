...
function hp_draw_win()
    ...
    top = top + 20
    -- 精神
    WindowText(hp_win, FONT_NAME, "精神", left, top, 0, 0, ColourNameToRGB("white"), false)
    Fun_DrawGrid2(
        hp_win,
        status.jing,
        status.jing_curmax,
    ...
    top = top + 15
    -- 气血
    WindowText(hp_win, FONT_NAME, "气血", left, top, 0, 0, ColourNameToRGB("white"), false)
    Fun_DrawGrid2(
        hp_win,
        status.qi,
        status.qi,
    ...
    top = top + 15
    -- 精力
    WindowText(hp_win, FONT_NAME, "精力", left, top, 0, 0, ColourNameToRGB("white"), false)
    ...
    top = top + 15
    -- 内力
    WindowText(hp_win, FONT_NAME, "内力", left, top, 0, 0, ColourNameToRGB("white"), false)
    ...
    top = top + 15
    -- 食物
    WindowText(hp_win, FONT_NAME, "食物", left, top, 0, 0, ColourNameToRGB("white"), false)
    Fun_DrawGrid(
        hp_win,
        status.shiwu,
        status.shiwu_max,
    ...
    WindowText(
        ...
        FONT_NAME,
        "合气度",
        hp_win_width - 6 - WindowTextWidth(hp_win, FONT_NAME, "合气度"),
        top,
        0,
        0,
        ColourNameToRGB("white"),
    ...
    top = top + 15
    -- 饮水
    WindowText(hp_win, FONT_NAME, "饮水", left, top, 0, 0, ColourNameToRGB("white"), false)
    Fun_DrawGrid(
        hp_win,
        status.yinsui,
        status.yinsui_max,
    ...
    top = top + 15
    -- 潜能
    WindowText(hp_win, FONT_NAME, "潜能", left, top, 0, 0, ColourNameToRGB("white"), false)
    WindowText(
        hp_win,
        FONT_NAME,
    ...
    -- 存款
    WindowText(hp_win, FONT_NAME, "存款：" .. score.gold, left + 130, top, 0, 0, ColourNameToRGB("white"), false)

    if status.yun == 1 then
        -- 运精气
        WindowText(hp_win, FONT_NAME, "运气中", hp_win_width - 41, top, 0, 0, ColourNameToRGB("yellow"), false)
    elseif status.yun == 2 then
        WindowText(hp_win, FONT_NAME, "运精中", hp_win_width - 41, top, 0, 0, 0xFFDA58, false)
    end

    top = top + 15
    -- 经验
    WindowText(hp_win, FONT_NAME, "经验", left, top, 0, 0, ColourNameToRGB("white"), false)
    WindowText(
        hp_win,
        FONT_NAME,
    ...
    if status.jiali == true then
        WindowText(hp_win, FONT_NAME, "运功中", hp_win_width - 41, top, 0, 0, ColourNameToRGB("red"), false)
    ---------//无BUFF自动BUFF
    -- else
    -- Execute("BUFF");
    end
    ...
    top = top + 15
    WindowText(hp_win, FONT_NAME, "任务：" .. quest.name, left - 1, top, 0, 0, ColourNameToRGB("white"), false)
    WindowText(hp_win, FONT_NAME, "地点：" .. quest.location, left + 130, top, 0, 0, ColourNameToRGB("white"), false)
    top = top + 15
    WindowText(hp_win, FONT_NAME, "状态：" .. quest.status, left, top, 0, 0, ColourNameToRGB("white"), false)
    WindowText(hp_win, FONT_NAME, "目标：" .. quest.target, left + 130, top, 0, 0, ColourNameToRGB("white"), false)
    top = top + 15
    WindowText(hp_win, FONT_NAME, "描述：" .. quest.misc, left, top, 0, 0, ColourNameToRGB("white"), false)
    top = top + 15
    WindowText(hp_win, FONT_NAME, "备注：" .. quest.misc2, left, top, 0, 0, ColourNameToRGB("white"), false)
    top = top + 25
    local jobDuration = ""
    if job.statistics.Duration ~= nil then
        jobDuration = job.statistics.Duration
    end
    WindowText(hp_win, FONT_NAME, "本次运行时间：" .. jobDuration, left, top, 0, 0, ColourNameToRGB("gold"), false)
    top = top + 15
    WindowText(
        hp_win,
        FONT_NAME,
        "共接取任务: " .. job.statistics.Times .. " 次",
        left,
        top,
        0,
        0,
    ...
    WindowText(
        hp_win,
        FONT_NAME,
        "华山完成：" .. job.statistics.Category["华山"].Success,
        left - 1,
        top,
        0,
        0,
    ...
    WindowText(
        hp_win,
        FONT_NAME,
        "失败：" .. job.statistics.Category["华山"].Failure,
        left + 130,
        top,
        0,
        0,
    ...
    WindowText(
        hp_win,
        FONT_NAME,
        "武当完成：" .. job.statistics.Category["武当"].Success,
        left - 1,
        top,
        0,
        0,
    ...
    WindowText(
        hp_win,
        FONT_NAME,
        "失败：" .. job.statistics.Category["武当"].Failure,
        left + 130,
        top,
        0,
        0,
    ...
    WindowText(
        hp_win,
        FONT_NAME,
        "失败：" .. job.statistics.Category["送信"].Failure,
        left + 130,
        top,
        0,
        0,
    ...
    WindowText(
        hp_win,
        FONT_NAME,
        "颂摩崖完成：" .. job.statistics.Category["颂摩崖"].Success,
        left - 1,
        top,
        0,
        0,
    ...
    WindowText(
        hp_win,
        FONT_NAME,
        "死亡：" .. job.statistics.Category["颂摩崖"].Failure,
        left + 130,
        top,
        0,
        0,
    ...
    WindowText(
        hp_win,
        FONT_NAME,
        "失落的信笺完成：" .. job.statistics.Category["失落的信笺"].Times,
        left - 1,
        top,
        0,
        0,
    ...
    WindowText(hp_win, FONT_NAME, "共计获取经验：" .. ExpScore, left, top, 0, 0, ColourNameToRGB("red"), false)
    top = top + 15
    WindowText(
        hp_win,
        FONT_NAME,
        "每小时获取经验：" .. job.statistics.Efficiency,
        left,
        top,
        0,
        0,
    ...
    WindowText(hp_win, FONT_NAME, "当前发呆计时：" .. idletime * 30 .. " 秒", left, top, 0, 0, ColourNameToRGB("gray"), false)
